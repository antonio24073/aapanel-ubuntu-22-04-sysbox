...
The mail tag has roundcube and the one-click install needs nginx and mysql 5.7. So it's a nginx modified. But it works in apache too. Only the auto install button that do not works.
